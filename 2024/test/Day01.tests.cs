...
{
    [TestMethod]
    public void ShouldReturnADistanceOfTwoFor3And1()
    {
        Day01.distance(3,1).Should().Be(2);
    }

    [TestMethod]
    public void ShouldReturnADistanceOfTwoFor1And3()
    {
        Day01.distance(1,3).Should().Be(2);
    }

    [TestMethod]
    public void ShouldReturn11ForTheGivenExampleInput()
    {
        ...
        var actualResult = Day01.distance(firstList, secondList);

        actualResult.Should().Be(expectedResult);
    }

    [TestMethod]
    public void ShouldReturnCorrectResultForActualInput() {
