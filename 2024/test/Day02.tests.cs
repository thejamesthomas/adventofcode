...
namespace test
{
    ...
    {
        [TestMethod]
        public void IsSafe_ShouldReturnTrueForSimpleIncreaseOf1Or2()
        {
            const string input = "7 6 4 2 1";

            Day02.IsSafe(input).Should().BeTrue();
        }

        [TestMethod]
        public void IsSafe_ShouldReturnFalseWhenAnIncreaseOf5IsInInput()
        {
            const string input = "1 2 7 8 9";

            Day02.IsSafe(input).Should().BeFalse();
        }

        [TestMethod]
        public void IsSafe_ShouldReturnFalseWhenADecreaseOf4IsInInput()
        {
        ...
        [TestMethod]
        public void IsSafe_ShouldReturnFalseWhenADecreaseFollowsAnIncrease()
        {
        ...
        [TestMethod]
        public void IsSafe_ShouldReturnFalseWhenInputContainsNoIncrease()
        {
        ...
        [TestMethod]
        public void IsSafe_ShouldReturnTrueWhenInputIsSafe()
        {
        ...
        [TestMethod]
        public void CountSafe_ShouldReturnTwoForTheExampleInput()
        {
            const string input = """
                                 7 6 4 2 1
                                 1 2 7 8 9
            ...
            Day02.CountSafe(input).Should().Be(2);
        }
